...
FIXED: Uses 'english_author' column instead of 'author'
"""
...
class SovietJournalBayesianNetwork:
    ...
    def _load_and_preprocess_data(self, data_path: str):
        ...
        # FIXED: Check for english_author column instead of author
    ...
    def _create_mappings(self):
        ...
        """
        # FIXED: Author mapping - learn from english_author column
    ...
    def _learn_from_data(self):
        """
        Learn local conditional probabilities from data using Maximum Likelihood Estimation
        """
    ...
    def _compute_joint_distribution(self):
        ...
        Note: All observed data is published, so we compute P(D,GS,A,J | Published=1)
        """
...
def create_example_csv(output_path: str = "example_soviet_journals.csv"):
    ...
    """
    # FIXED: Uses english_author instead of author
    example_data = {
